package org.fullcycle.admin.catalog.infrastructure.configuration.properties.google;
...
public class GoogleCloudStorageProperties implements InitializingBean {
    ...
    private static final Logger log = LoggerFactory.getLogger(GoogleCloudStorageProperties.class);
