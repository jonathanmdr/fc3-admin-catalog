...
class UpdateVideoUseCaseTest extends UseCaseTest {
    ...
    void givenAValidCommandWithoutResources_whenCallsUpdateVideo_shouldReturnVideoId() {
        ...
        final var expectedVideo = audioVideoMedia(Type.VIDEO);
        final var expectedTrailer = audioVideoMedia(Type.TRAILER);
        final var expectedBanner = imageMedia(Type.BANNER);
        final var expectedThumbnail = imageMedia(Type.THUMBNAIL);
        final var expectedThumbnailHalf = imageMedia(Type.THUMBNAIL_HALF);
